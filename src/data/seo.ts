...
export const PAGE_SEO: Record<string, PageSEO> = {
  '/': {
    ...
    relatedLinks: ['/servicios/', '/proceso/', '/cobertura/', '/nosotros/', '/faq/', '/contacto/'],
  },
  ...
  '/servicios/': {
    ...
    relatedLinks: ['/servicios/hogar/', '/servicios/comercio/', '/servicios/industrial/', '/servicios/control-acceso/', '/proceso/', '/cobertura/', '/faq/'],
  ...
  '/nosotros/': {
    ...
    relatedLinks: ['/servicios/', '/proceso/', '/cobertura/', '/faq/', '/contacto/'],
  ...
  '/proceso/': {
    ...
    relatedLinks: ['/servicios/', '/cobertura/', '/nosotros/', '/faq/', '/contacto/'],
  ...
  '/cobertura/': {
    ...
    relatedLinks: ['/servicios/', '/proceso/', '/nosotros/', '/faq/', '/contacto/'],
  ...
  '/faq/': {
    ...
    relatedLinks: ['/servicios/', '/proceso/', '/cobertura/', '/nosotros/', '/contacto/'],
  ...
  '/contacto/': {
    ...
    relatedLinks: ['/servicios/', '/proceso/', '/cobertura/', '/nosotros/', '/faq/'],
...
export function getRelatedLinks(currentPath: string, maxLinks = 6): RelatedLink[] {
  ...
  if (!config) {
    ...
    return ['/servicios/', '/nosotros/', '/proceso/', '/cobertura/', '/faq/']
